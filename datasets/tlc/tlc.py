...
_URLs = {
    "tlcv1.0": "https://archive.org/download/tlc_v.2.0.tar/tlc_v.1.0.tar.gz",
    "tlcv2.0": "https://archive.org/download/tlc_v.2.0.tar/tlc_v.2.0.tar.gz",
    "tnhcv1.0": "https://archive.org/download/tlc_v.2.0.tar/tnhc_v.1.0.tar.gz",
}
